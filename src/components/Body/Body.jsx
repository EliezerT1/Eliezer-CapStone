...
const Body = () => {
    return (
        <>
            ...
            >
                <div className="flex justify-center items-center pt-[64px] pb-[64px] px-[48px] max-md:flex-col w-full">
                    <div className="flex flex-col gap-7 items-center text-center w-full md:w-1/2">
                        ...
                        <p className="text-lg w-full" id='about me'>
                            I’m a first-generation Dominican-American from the Bronx and the very first in my family to attend college. I’m currently pursuing a B.S. in Computer Science with a minor in Cybersecurity at Fordham University , where I balance full-time studies with an intensive tech apprenticeship
                        </p>
                    </div>
            ...
            >
                {/* ───────────── TIMELINE ───────────── */}
                <h2 className="text-4xl font-bold text-center mb-16 tracking-tight">Timeline</h2>
                <div className="relative w-full flex justify-center">
                    ...
                    <div className="w-full max-w-6xl px-4 mx-auto z-10">
                        ...
                        {[
                            ...
                            {
                                title: "Technology Youth Apprentice, Accenture",
                            ...
                            <div
                                key={event.title}
                                className={`relative flex items-center mb-14 ${idx % 2 === 0 ? 'justify-start' : 'justify-end'} group`}
                            >
                                {/* Dot */}
                                <span className="absolute left-1/2 -translate-x-1/2 z-20 w-6 h-6 rounded-full bg-white border-4 border-blue-400 group-hover:border-pink-400 transition-all duration-300 shadow-lg" />
                                {/* Card */}
                                <div className={`w-full md:w-1/2 ${idx % 2 === 0 ? 'pr-12 md:pr-16' : 'pl-12 md:pl-16'}`}>
                                    <motion.div
                                        initial={{ opacity: 0, y: 40 }}
                                        whileInView={{ opacity: 1, y: 0 }}
                                        transition={{ duration: 0.5, delay: idx * 0.1 }}
                                        viewport={{ once: true }}
                                        className="bg-white p-6 rounded-xl shadow-xl border border-blue-100"
                                    >
